...
<section class="plugin-classifieds pictures-manage">
		...
		<?=form_helper::openForm()?>
								...
								<div class="row <?=text_helper::alternate('odd','even')?>" id="input_row_picture_delete">
									...
									<div class="field">
										...
										<? view::load('system/elements/field/edit', array(
											'prefix' => 'picture',
											'field' => array(
												'name' => __('picture_delete_check', 'classifieds'),
			...
			<fieldset class="form">
				...
				<div class="row actions">
					...
					&nbsp;
					<?=html_helper::anchor('classifieds/pictures/index/'.$ad['ad_id'].'/'.text_helper::slug($ad['data_title'], 100), __('cancel', 'system'))?>
				</div>
