...
<section class="plugin-classifieds ads-index">
					...
					<article class="item">
						...
						<footer class="item-footer">
							...
							<ul class="unstyled content-meta clearfix">
								<li class="date">
									<?=__('author_date', 'system_info', array('%author' => users_helper::anchor($ad['user']), '%date' => date_helper::formatDate($ad['post_date'])))?>
								</li>
