...
class Pages_Languages_Hook extends Hook
{
	public function install($languageID, $language)
	{
		$this->dbforge->addColumn(':prefix:pages_data', array(
	...
	{
		$this->dbforge->dropColumns(':prefix:pages_data', array('data_title_' . $language));
		$this->dbforge->dropColumns(':prefix:pages_data', array('data_body_' . $language));
		$this->dbforge->dropColumns(':prefix:pages_data', array('data_meta_keywords_' . $language));
		$this->dbforge->dropColumns(':prefix:pages_data', array('data_meta_description_' . $language));
